...
rod_protos_ordered = {
  {name=shared.han2, limit_cf=2.0, add_capture_prob=1.5,},
  {name=shared.han1, limit_cf=1.5, add_capture_prob=0.7,},
  {name=shared.rod2, limit_cf=1.5, add_capture_prob=0.7,},
  {name=shared.rod1, limit_cf=1.0, add_capture_prob=0.2,},
}
