    ...
    data:extend({
      {
        ...
        frame_count = 1,
        width = titan_type.plane_size,
        height = titan_type.plane_size,
...
----- Weapons -----
  ...
  {
    type = "animation",
    name = shared.mod_prefix.."VolcanoCannon",
    filename = shared.media_prefix.."graphics/weapons/VolcanoCannon.png",
    frame_count = 1,
    width = 160,
    height = 580,
    shift = util.by_pixel(0, -110),
  ...
  {
    type = "animation",
    name = shared.mod_prefix.."Gatling-Blaster",
    filename = shared.media_prefix.."graphics/weapons/Gatling-Blaster.png",
    frame_count = 1,
    width = 160,
    height = 480,
  ...
  {
    type = "animation",
    name = shared.mod_prefix.."Plasma-SunFury",
    filename = shared.media_prefix.."graphics/weapons/Plasma-SunFury.png",
    frame_count = 1,
    width = 192,
    height = 576,
    shift = util.by_pixel(0, -130),
  ...
  {
    type = "animation",
    name = shared.mod_prefix.."Plasma-Suzerain",
    filename = shared.media_prefix.."graphics/weapons/Plasma-Suzerain.png",
    frame_count = 1,
    width = 256,
    height = 512,
    shift = util.by_pixel(0, -130),
  ...
  {
    type = "animation",
    name = shared.mod_prefix.."Plasma-Annihilator",
    filename = shared.media_prefix.."graphics/weapons/Plasma-Annihilator.png",
    frame_count = 1,
    width = 256,
    height = 768,
  ...
  -- {
  --   type = "animation",
  --   name = shared.mod_prefix.."ChainSword",
  --   filename = shared.media_prefix.."graphics/weapons/Sword-mock.png",
  --   frame_count = 1,
  --   width = 240,
  --   height = 640,
  ...
  -- },
  {
    type = "animation",
    name = shared.mod_prefix.."ChainSword",
    filename = shared.media_prefix.."graphics/weapons/ChainSword.png",
    frame_count = 1,
    width = 256, height = 768,
    shift = util.by_pixel(0, -290),
  },
  {
    type = "animation",
    name = shared.mod_prefix.."Arm",
    filename = shared.media_prefix.."graphics/titans/arm.png",
    frame_count = 1,
    width = 256, height = 512, scale = 0.5,
    shift = util.by_pixel(0, -116),
  },
  -- {
  --   type = "animation",
  --   name = shared.mod_prefix.."Arm",
  --   filename = shared.media_prefix.."graphics/titans/arm-mock.png",
  --   frame_count = 1,
  --   width = 128,
  --   height = 256,
